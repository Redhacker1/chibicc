...
// Prepares LLIR for backends by standardizing addressing modes, immediate
// binary operations, and comparison/branch instructions.
// ============================================================================
...
static bool run_legalize_isel_pass(IRFunction *fn, IRPassContext *ctx) {
  (void)ctx;
...
IRPass pass_legalize_isel = {
  ...
  .enabled = true,
  .default_opt_level = 1,
  .run_on_function = run_legalize_isel_pass,
};
