...
static int add_millions(void) {
  ...
  pthread_create(&thr1, NULL, (void *(*)(void *))add1, &x);
  pthread_create(&thr2, NULL, (void *(*)(void *))add2, &x);
  pthread_create(&thr3, NULL, (void *(*)(void *))add3, &x);
