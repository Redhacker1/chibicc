...
int main() {
  ...
  ASSERT(0, ({ _Alignas(16) char x[16]; (unsigned long long)&x % 16; }));
  ASSERT(0, ({ _Alignas(16) char x[17]; (unsigned long long)&x % 16; }));
  ASSERT(0, ({ _Alignas(16) char x[100]; (unsigned long long)&x % 16; }));
  ASSERT(0, ({ _Alignas(16) char x[101]; (unsigned long long)&x % 16; }));
