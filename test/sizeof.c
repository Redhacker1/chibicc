...
int main() {
  ...
  ASSERT(sizeof(long), sizeof(-10 + (long)5));
  ASSERT(sizeof(long), sizeof(-10 - (long)5));
  ASSERT(sizeof(long), sizeof(-10 * (long)5));
  ASSERT(sizeof(long), sizeof(-10 / (long)5));
  ASSERT(sizeof(long), sizeof((long)-10 + 5));
  ASSERT(sizeof(long), sizeof((long)-10 - 5));
  ASSERT(sizeof(long), sizeof((long)-10 * 5));
  ASSERT(sizeof(long), sizeof((long)-10 / 5));
  ...
  ASSERT(sizeof(long), sizeof(unsigned long int));
  ...
  ASSERT(sizeof(long), sizeof(1?(long)2:(char)3));
  ...
  ASSERT(sizeof(long double), sizeof(long double));
