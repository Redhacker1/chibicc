...
When a value of a type of class INTEGER is returned or passed in a register
...
bits are significant, together forming the value 0 or 1.}
...
in the function prologue to hold the GOT address\footnote{If, at code
...
the prologue code that initializes it may be omitted.} for non-leaf
...
\begin{figure}[H]
\Hrule
\caption{Position-Independent Function Prologue Code} \label{large_pic_prolog}
medium model:
\begin{footnotesize}
\begin{verbatim}
